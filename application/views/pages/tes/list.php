            ...
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <a href="#" class="btn btn-primary d-none d-sm-inline-block btnAddTes" data-bs-toggle="modal" data-bs-target="#addTes">
                            ...
                            <a href="#" class="btn btn-primary d-sm-none btn-icon btnAddTes" data-bs-toggle="modal" data-bs-target="#addTes" aria-label="Create new report">
                                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <line x1="12" y1="5" x2="12" y2="19" />
                        ...
                        <table id="dataTable" class="responsive table card-table table-vcenter text-nowrap text-dark">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-dark desktop mobile-l mobile-p tablet-l tablet-p" style="font-size: 11px">Tipe Tes</th>
                                    <th class="text-dark desktop w-1" style="font-size: 11px">Tgl Tes</th>
                                    <!-- <th class="text-dark none" style="font-size: 11px">Tgl Pengumuman</th> -->
                                    <th class="text-dark desktop w-1" style="font-size: 11px">Soal</th>
                                    <th class="text-dark none w-1" style="font-size: 11px">Peserta</th>
                                    <!-- <th class="text-dark desktop w-1" style="font-size: 11px">Sertifikat</th> -->
                                    <th class="text-dark none" style="font-size: 11px">Status</th>
