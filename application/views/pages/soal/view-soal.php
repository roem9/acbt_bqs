                                ...
                                ?>
                                    <?php if ($data['item'] == "soal") : ?>
                                        ...
                                        <?php foreach ($data['data']['pilihan'] as $k => $choice) : ?>
                                            <?php if ($choice == $data['data']['jawaban']) $checked = "checked";
                                    ...
                                    <?php elseif ($data['item'] == "soal berbobot") : ?>
                                        ...
                                        <?php foreach ($data['data']['pilihan'] as $k => $choice) : ?>
                                            <?php
                                            // if($choice == $data['data']['jawaban']) $checked = "checked"; else $checked = "disabled";
                                            $checked = "disabled";
                                            ?>
                                            <?php $pilihan .= '
                                                        <div class="mb-3">
                                                            <label>
                                                                <input type="radio" data-id="' . $index . '|' . $i . '"  name="radio-' . $index . '[' . $i . ']" value="' . $choice . '" ' . $checked . '> 
                                                                <span>' . $choice . ' (' . $data['data']['bobot'][$k] . ')</span>
                                                            </label>
                                                        </div>' ?>
                                        <?php endforeach; ?>
