			...
			sesi +=
				...
				`">
                        <svg width="24" height="24" class="text-danger">
                            <use xlink:href="` +
				url_base +
				`assets/tabler-icons-1.39.1/tabler-sprite.svg#tabler-trash" />
                        </svg> 
                    </a>
                </li>`;
			num++;
        ...
        <div class="alert alert-important alert-warning alert-dismissible" role="alert">
            <div class="d-flex">
                <svg width="24" height="24" class="me-1">
                    <use xlink:href="` +
			url_base +
			`assets/tabler-icons-1.39.1/tabler-sprite.svg#tabler-alert-circle" />
                </svg> 
                <div>
                    Sesi kosong
                </div>
...
$("[name='tipe_soal']").change(function () {
	...
	if ($(this).val() == "Latihan" || $(this).val() == "Placement Test") {
		$("[name='poin']").prop("disabled", false);
